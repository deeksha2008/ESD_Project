...
import com.deeksha.timetable.service.TokenService;
...
public class OAuthController {
    ...
    public void callback(@RequestParam("code") String code, HttpServletResponse response) throws IOException {
        try {
            ...
            try {
                com.deeksha.timetable.service.StudentService studentService = applicationContext.getBean(com.deeksha.timetable.service.StudentService.class);
